...
int shop(int character, int level , Player *ptr){
	...
	switch(character)
	{
		...
		cout << "1-Sword               		 	Damage: 5       Price:500"<<endl<<endl;
		SetConsoleTextAttribute(console, 12);
		cout << "2-Dagger              		 	Damage: 5       Price:500"<<endl<<endl;
		cout << "3-Staff   			   	Damage: 5       Price:500"<<endl<<endl;
		SetConsoleTextAttribute(console, 10);
		cout << "4-Sange               		 	Damage: 10      Price:1500"<<endl<<endl;
		SetConsoleTextAttribute(console, 12);
		cout << "5-Yasha               		 	Damage: 10      Price:1500"<<endl<<endl;
		cout << "6-Stormbringer                		Damage: 10      Price:1500"<<endl<<endl;
		SetConsoleTextAttribute(console, 10);
		cout << "7-Nightbane	               		Damage: 20      Price:2500"<<endl<<endl;
		SetConsoleTextAttribute(console, 12);
		cout << "8-Dragonfang			      	Damage: 20      Price:2500"<<endl<<endl;
		cout << "9-Deathraze			       	Damage: 20      Price:2500"<<endl<<endl;
		SetConsoleTextAttribute(console, 10);
		cout << "10-Endbringer	            		Damage: 30      Price:3000"<<endl<<endl;
		SetConsoleTextAttribute(console, 12);
		cout << "11-Daedulus               	 	Damage: 30      Price:3000"<<endl<<endl;
		cout << "12-Lifebinder       			Damage: 30      Price:3000"<<endl<<endl;
		SetConsoleTextAttribute(console, 10);
		cout << "13-Shadowmourne             		Damage: 50      Price:5000"<<endl<<endl;
		SetConsoleTextAttribute(console, 12);
		cout << "14-Frostmourne              		Damage: 50      Price:5000"<<endl<<endl;
		cout << "15-Desolation				Damage: 50      Price:5000"<<endl<<endl;
		break;
		case 2:
		SetConsoleTextAttribute(console, 12);
		cout << "1-Sword               		 	Damage: 5       Price:500"<<endl<<endl;
	...
	while(1){
		...
		if(itemchoice == 1 && ptr->getgold() >= 500 && character == 1 )
		{
		...
		else if (itemchoice == 2 && ptr->getgold() >= 500 && character == 2 )
		{			
			cout<<"Dagger Bought."<<endl;
			ptr->item_holding = "Dagger";
			ptr->setgold(ptr->getexp() - 500 );
			getch();
			SetConsoleTextAttribute(console, 7);
			return 5;		
		}
		else if (itemchoice == 3 && ptr->getgold() >= 500 && character == 3 )
		{			
		...
		else if(itemchoice == 4 && ptr->getgold() >= 1500 && character == 1  )
		{
			cout<<"Sange Bought."<<endl;
			ptr->item_holding = "Sange";
			ptr->setgold(ptr->getexp() - 1500 );
			getch();
			SetConsoleTextAttribute(console, 7);
			return 10;
		}
		else if (itemchoice == 5 && ptr->getgold() >= 1500 && character == 2 )
		{			
		...
		else if (itemchoice == 6 && ptr->getgold() >= 1500 && character == 3 )
		{			
			cout<<"Stormbringer Bought."<<endl;
			ptr->item_holding = "Stormbringer";
			ptr->setgold(ptr->getexp() - 1500 );
			getch();
			SetConsoleTextAttribute(console, 7);
			return 10;		
		}
		else if(itemchoice == 7 && ptr->getgold() >= 2500  && character == 1  )
		{
			cout<<"Nightbane Bought."<<endl;
			ptr->item_holding = "Nightbane";
			ptr->setgold(ptr->getexp() - 2500 );
			getch();
			SetConsoleTextAttribute(console, 7);
			return 20;
		}
		else if (itemchoice == 8 && ptr->getgold() >= 2500 && character == 2 )
		{			
			cout<<"Dragonfang Bought."<<endl;
			ptr->item_holding = "Dragonfang";
			ptr->setgold(ptr->getexp() - 2500 );
			getch();
			SetConsoleTextAttribute(console, 7);
			return 20;		
		}
		else if (itemchoice == 9 && ptr->getgold() >= 2500 && character == 3 )
		{			
			cout<<"Deathraze Bought."<<endl;
			ptr->item_holding = "Deathraze";
			ptr->setgold(ptr->getexp() - 2500 );
			getch();
			SetConsoleTextAttribute(console, 7);
			return 20;		
		}
		else if(itemchoice == 10 && ptr->getgold() >= 3000  && character == 1  )
		{
			cout<<"Endbringer Bought."<<endl;
			ptr->item_holding = "Endbringer";
			ptr->setgold(ptr->getexp() - 3000 );
			getch();
			SetConsoleTextAttribute(console, 7);
			return 30;
		}
		else if (itemchoice == 11 && ptr->getgold() >= 3000 && character == 2 )
		{			
		...
		else if (itemchoice == 12 && ptr->getgold() >= 3000 && character == 3 )
		{			
			cout<<"Lifebinder Bought."<<endl;
			ptr->item_holding = "Lifebinder";
			ptr->setgold(ptr->getexp() - 3000 );
			getch();
			SetConsoleTextAttribute(console, 7);
			return 30;		
		}
		else if(itemchoice == 13 && ptr->getgold() >= 5000 && character == 1  )
		{
			cout<<"Shadowmourne Bought."<<endl;
			ptr->item_holding = "Shadowmourne";
			ptr->setgold(ptr->getexp() - 5000 );
			getch();
			SetConsoleTextAttribute(console, 7);
			return 50;
		}
		else if (itemchoice == 14 && ptr->getgold() >= 5000 && character == 2 )
		{			
		...
		else if (itemchoice == 15 && ptr->getgold() >= 5000 && character == 3 )
		{			
			cout<<"Desolation Bought."<<endl;
			ptr->item_holding = "Desolation";
			ptr->setgold(ptr->getexp() - 5000 );
			getch();
			SetConsoleTextAttribute(console, 7);
			return 50;		
...
class MiniBoss: virtual public Enemy{
	public:
		static const int axeslash 	 = 30;
		static const int charge   	 = 50;
		static const int groundsmash = 90;
...
class Boss: virtual public Enemy {
	public:
		static const int stomp 		 = 70;
		static const int boulder 	 = 90;
		static const int energybeam  = 110;
		static const int flameshower = 150;
		static const int godswrath   = 200;
		...
		void BAG(Player *ptr , string playertype){
			...
			while (choice != 0){
				if (ptr->bag[choice-1] == "Potion"){
					...
					ptr->sethealth(ptr->gethealth() + 100);
					break;
				}
...
class Save{
	public:
		...
		void save(string A, double maxhealth, double maxResource, int banditNo, int level, int gold, string *bag , string holding , int weapondmg ){
			...
			save<<A<<" "<<maxhealth<<" "<<maxResource<<" "<<banditNo<<" "<<level<<" "<<gold<<" "<<bag[0]<<" "<<bag[1]<<" "<<bag[2]<<" "<<bag[3]<<" "<<bag[4]<<" "<<weapondmg<<" "<<holding;
			save.close();
		...
		string load(){
			...
			load>>tempA>>tempH>>tempR>>tempband>>templevel>>tempgold>>tempitem[0]>>tempitem[1]>>tempitem[2]>>tempitem[3]>>tempitem[4]>>tempweapondmg>>holding;
			if(tempA == "Warrior"){
		...
		void AttackMenu(Mage &M, Inventory &I ,Enemy *E, int bandit_number,string enemytype){
			...
			if (option == 1){
				...
				cin >> abilityoption;
					...
					{
						E->sethealthE( E->gethealthE() - (35+ M.dmg + M.getitemmultiplier() ) );
						M.setmana(M.getmana() - 10);
						cout<<"Damage dealt = "<< (35+ M.dmg + M.getitemmultiplier()) <<endl;
					...
					else if(abilityoption == 3 && M.getlevel() >= 3 && M.getmana() >= 15)
					{
						...
						M.setmana(M.getmana() - 13);
						cout<<"Damage dealt = "<< (50+ M.dmg + M.getitemmultiplier()) <<endl;
						cout<<"Mana Reduced = -13\n";

					}
					else if(abilityoption == 4 && M.getlevel() >= 4 && M.getmana() >= 20)
					{
						E->sethealthE( E->gethealthE() - (70+ M.dmg + M.getitemmultiplier() ) );
						M.setmana(M.getmana() - 17);
						cout<<"Damage dealt = "<< (70+ M.dmg + M.getitemmultiplier()) <<endl;
						cout<<"Mana Reduced = -17\n";
					}
					else if(abilityoption == 5 && M.getlevel() >= 6 && M.getmana() >= 25)
					{

						E->sethealthE( E->gethealthE() - (85+ M.dmg + M.getitemmultiplier() ) );
						M.setmana(M.getmana() - 22);
						cout<<"Damage dealt = "<< (85+ M.dmg + M.getitemmultiplier()) <<endl;
						cout<<"Mana Reduced = -22\n";
					...
					{
						E->sethealthE( E->gethealthE() - (130+ M.dmg + M.getitemmultiplier() ) );
						M.setmana(M.getmana() - 30);
						cout<<"Damage dealt = "<< (130+ M.dmg + M.getitemmultiplier()) <<endl;
						cout<<"Mana Reduced = -30\n";
					...
					else if(abilityoption == 8 && M.getlevel() >= 10 && M.getmana() >= 60)
					{
						...
						cout<<"Damage dealt = "<< (200+ M.dmg + M.getitemmultiplier() ) <<endl;
